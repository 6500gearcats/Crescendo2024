...
public class GrabNoteAuto extends SequentialCommandGroup {
  /** Creates a new GrabNoteAuto. */
  public GrabNoteAuto(NoteFinder NoteFinder, DriveSubsystem Drive, Intake Intake, Shooter Shooter, GenericHID GunnerController) {
